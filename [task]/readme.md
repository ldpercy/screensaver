...
* Figure out a way to close a bezier curve smoothly
* Fix the dumb code in the line movers
* Figure out how to manually stop/start key-frame animations
* Non-black dark background to help some of blend-modes
* Preserve settings on module change, so changing back takes you to the previous state
* Copies/shadows with sibling-index() & sibling-count()
